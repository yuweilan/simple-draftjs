  ...
  _createClass(PlatziEditor, [{
    ...
    value: function onChange(editorState) {
      ...
      if (!this.props.isDetail) {
        this.props.getContentAction(this.props.export === 'markdown' ? this.getMarkdown() : this.getHtml(), (0, _draftJs.convertToRaw)(editorState.getCurrentContent()));
      }
    }
    ...
    value: function render(_ref) {
      ...
      var inactiveStyle = _ref.inactiveStyle;
      var classInactive = _ref.classInactive;
      ...
      var cssStyle = inactiveStyle ? inactiveStyle : {
        background: '#ddd',
        color: '#ccc',
        cursor: 'wait'
      };
      var style = inactive ? cssStyle : null;
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
    ...
    key: 'getFilteredHTML',
    value: function getFilteredHTML(_ref2) {
