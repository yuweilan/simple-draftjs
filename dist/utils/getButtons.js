...
var options = _immutable2.default.Map({
  ...
  'h1': { label: 'H1', style: 'h1', classname: 'h1', type: 'block' },
  'h2': { label: 'H2', style: 'h2', classname: 'h2', type: 'block' },
  'h3': { label: 'H3', style: 'h3', classname: 'h3', type: 'block' },
  'h4': { label: 'H4', style: 'h4', classname: 'h4', type: 'block' },
